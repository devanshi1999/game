...
var x = 150, y=innerHeight - 50, dx, dy, radius=10, gravity = 0.25, angleRadian, speed = 17, slope, flag = true, count1 =0, count2 = 0, player1 = true, player2 = false, hitOn, winner,X,Y,D;
...
canvas.addEventListener('click', function(e1) {
	    ...
	    circleY = e1.clientY;
	    if(player1 == true ) {
	        X=innerHeight - 50 - circleY;
	        Y=circleX - 150;
	        D=Math.sqrt(X*X+Y*Y)/700;
	        speed=D*17;
	        slope = X/Y;
